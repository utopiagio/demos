...
/* github.com/utopiagio/demos/GoRadioButton/demoradiobutton.go */
...
func main() {
    ...
    app := ui.GoApplication("GoRadioButtonDemo")
    // create application window
    mainwin = ui.GoMainWindow("GoRadioButton Demo - UtopiaGio Package")
    ...
    buttonGroup := ui.GoButtonGroup()

    radButton0 := ui.GoRadioButton(layoutLblSizing, buttonGroup, "rad0", "Fixed")
    radButton0.SetSizePolicy(ui.FixedWidth, ui.FixedHeight)
    radButton0.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)
    radButton0.SetWidth(500)
    radButton0.SetHeight(50)
   
    ui.GoSpacer(layoutLblSizing, 10)

    radButton1 := ui.GoRadioButton(layoutLblSizing, buttonGroup, "rad1", "Preferred")
    radButton1.SetSizePolicy(ui.PreferredWidth, ui.PreferredHeight)
    radButton1.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)
 
    ui.GoSpacer(layoutLblSizing, 10)

    radButton2 := ui.GoRadioButton(layoutLblSizing, buttonGroup, "rad2", "Expanding")
    radButton2.SetSizePolicy(ui.ExpandingWidth, ui.ExpandingHeight)
    radButton2.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)

...
/* github.com/utopiagio/demos/GoListBox/demolistbox.go */
...
func main() {
    ...
    lstBox0 := ui.GoListBox(layoutBtnSizing)
    lstBox0.SetSizePolicy(ui.FixedWidth, ui.FixedHeight)
    lstBox0.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)
    lstBox0.SetWidth(300)
    lstBox0.SetHeight(100)
    ...
    lstBox2 := ui.GoListBox(layoutBtnSizing)
    lstBox2.SetSizePolicy(ui.ExpandingWidth, ui.ExpandingHeight)
    lstBox2.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)

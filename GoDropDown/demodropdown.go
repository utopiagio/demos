...
func main() {
    ...
    cmbBox0 := ui.GoCheckBox(layoutLblSizing, "Fixed")
    cmbBox0.SetSizePolicy(ui.FixedWidth, ui.FixedHeight)
    cmbBox0.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)
    cmbBox0.SetWidth(500)
    cmbBox0.SetHeight(50)
   
    ui.GoSpacer(layoutLblSizing, 10)

    cmbBox1 := ui.GoCheckBox(layoutLblSizing, "Preferred")
    cmbBox1.SetSizePolicy(ui.PreferredWidth, ui.PreferredHeight)
    cmbBox1.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)
 
    ui.GoSpacer(layoutLblSizing, 10)

    cmbBox2 := ui.GoCheckBox(layoutLblSizing, "Expanding")
    cmbBox2.SetSizePolicy(ui.ExpandingWidth, ui.ExpandingHeight)
    cmbBox2.SetBorder(ui.BorderSingleLine, 2, 6, ui.Color_LightBlue)
